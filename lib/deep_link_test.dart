...
class DeepLinkTest extends StatefulWidget {
  @override
  _DeepLinkTestState createState() => new _DeepLinkTestState();
}

enum UniLinksType { string, uri }

class _DeepLinkTestState extends State<DeepLinkTest>
  ...
  initPlatformStateForStringUniLinks() async {
    ...
    getLinksStream().listen((String link) {
      final linkSplit = link.split("//").last;
      print('got link: $linkSplit');
    }, onError: (err) {
      print('got err: $err');
    });
